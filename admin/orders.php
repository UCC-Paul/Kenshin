                ...
                <div class="projects">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="allorders.php"><button >See all <span class="las la-arrow-right"></span></button></a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="../admin/orders.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('Are you sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
                                            <a href="../admin/orders.php?edit=<?php echo $row['id']; ?>" class="option-btn" > <i class="fas fa-edit"></i> update </a>
                                        </td>
                                    </tr>
                                    ...
                                    <?php
                                        ...
                                        echo "<div class='empty'>no orders yeheeey!</div>";
                                        };
                                    ?>
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="reset" value="Cancel" class="option-btn" onclick="location.href='orders.php';">
