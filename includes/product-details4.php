...
<head>
	...
	<script src="https://use.fontawesome.com/a8product8.jpg178product8.jpg93387.js"></script>
</head>
<body>
		...
		<div class="container">
			<div class="navbar">
				<div class="logo">
					<a href="../index.html"><img src="../src/logo.png" width="128product8.jpgpx"></a>
				</div>
				<nav>
					<ul id="MenuItems">
		...
		<div class="small-container single-product">
			<div class="row">
				<div class="column">
					<img src="../src/products/product8.jpg" width="100%" id="ProductImg">


					<div class="small-img-row">
						<div class="small-img-col">
							<img src="../src/products/product8.jpg" width="100%" class="small-img">
						</div>
						<div class="small-img-col">
							<img src="../src/products/product8.jpg" width="100%" class="small-img">
						</div>
